...
print # blank line
#
# Option 1: Choose a song or chorus and write the program to output the lyrics using variables
# Option 2a: If you know about Python lists you could simplify the program above using a loop.
# Option 2b: If you completed 2a you may have noticed that all but one line has the form
